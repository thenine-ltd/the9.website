 ...
 * @since 1.0.0
 */
class MagicAI_Admin_Page_Vision extends MagicAI_Admin_Page {
	...
	public function __construct() {
		...
		$this->id = 'magicai-vision';
		$this->page_title = esc_html__( 'AI Vision', 'magicai-wp' );
		$this->menu_title = esc_html__( 'AI Vision', 'magicai-wp' );
		$this->parent = 'magicai';
		$this->position = '30';
	...
	public function display() {
		...
		include_once __DIR__ . '/views/vision.php'; 
