<div id="tab-product-generator" class="magicai-settings-form-page">
    <div class="magicai-generator-wrapper">

        <div class="generator-form">
            <form action="" class="magicai-generator product-generator magicai-form flex">
                <div class="form-field">
                    <label for="title">
                        <?php magicai_helper()->label_help_tip( 'Write details about the product content you want.' ); ?>
                ...
                <div class="form-field half">
                    <label for="number_of_results">
                        <?php magicai_helper()->label_help_tip( 'Choose the number of product content to be created.' ); ?>
