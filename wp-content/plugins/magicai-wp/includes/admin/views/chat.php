<div class="wrap">
    ...
    <div class="magicai-chat">
        ...
        <div class="magicai-chat--list">
            ...
            <button class="magicai-chat--new" data-type="chat">
            ...
            <?php magicai_helper()->get_chat_list( $atts ); ?>
        </div>
            ...
            <div class="magicai-chat--message-list">
                <div class="magicai-chat--message ai">
					<div class="text">
                        ...
                        <?php esc_html_e( 'How can I help you today?', 'magicai-wp' ); ?>
					</div>
				</div>
            </div>
            <form id="chat-form" class="magicai-chat--form" data-type="chat">
